...
const APPID = 'f1de9971';
const API_SECRET = 'ZGJmZTBhOTI1ZmUyMjk3MWE1ZDBkYWQ1';
const API_KEY = 'd6424302d8fddf00b9f6e21cedf9a045';
...
class TTSRecorder {
  constructor({ speed = 50, voice = 50, pitch = 50, voiceName = 'xiaoyan', appId = APPID, text = '', tte = 'UTF8', defaultText = '请输入您要合成的文本' } = {}) {
    this.speed = speed;
    this.voice = voice;
    this.pitch = pitch;
