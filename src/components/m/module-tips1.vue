<template>
  <div class="module-tips">
    <div class="module">
      ...
      <p class="em">技术面好</p>
      <p class="color-333 block">Level2功能主要是看大单金额和大单净量数据，大单净量代表大单金额占流通市值的百分比，强势涨停当天大单净量越大代表主力越坚决，控盘度越高，早上快速封板并且封板后无量最佳。</p>

      <p class="em">基本面</p>
      <p class="color-333 block">结合公司的市值、PE、股东数近期增减、增长预期等综合分析析，估值过高就要考虑安全边际，股东数增减代表近期主力动作。总之分仓操作才是安全的交易方式。</p>
