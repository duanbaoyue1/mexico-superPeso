<template>
  <div class="h5-content">
    ...
    <div class="head">Main information we collect:</div>
    <p>
      <strong>1. Contacts:</strong>
      PaisaGo may collect your contact information, including the names and phone numbers of your contacts. This collection will only be done with your consent. This information is also necessary for risk analysis to identify credible referrals, to assess your creditworthiness, and to identify fraudulent referrals. It will help you to check your creditworthiness. Yes, PaisaGo will not obtain or use this information from your mobile device without your consent. (This information is uploaded to: https://pro.paisago.in).
    </p>
    <br />
    <br />
    <p>
      <strong>2. SMS:</strong>
      PaisaGo stores and uploads your text messages in a legal manner (https://pro.paisago.in). The purpose of this text message access request is to evaluate the user's creditworthiness for loan origination purposes. Otherwise, collecting and evaluating your text messages and contact list is necessary to determine the criteria for genuine users and to prevent bots or temporary users from overloading the server.
    </p>
    <br />
    <br />
    <p>
      <strong>3. Device Information:</strong>
      We look for information about the devices you use, including brand, monitor, hardware, monitor, hardware system version, monitor and operating system version.
    </p>
    <br />
    <br />
    <p>
      <strong>4. Camera Information:</strong>
      For smooth lending, we use cameras for recognition and to strictly protect your information.
    </p>
    <br />
    <br />
    <p>
      <strong>5. Location Information:</strong>
      Location information is only collected while you are using our applications to determine if you are within the scope of our services. If you exit our application, we will no longer collect your location information.
    </p>
    <br />
    <br />
    <p>
      <strong>6.Phone status:</strong>
      To improve fraud detection and risk management, we need user profile data to collect and monitor certain information about your phone, such as your phone's unique device identifier. This information helps us uniquely identify users and detect and prevent unauthorized device activity on your behalf. We upload this information to (https://pro.paisago.in) and will only access or use it with your permission.
    </p>
    <br />
    <br />

    <p>
      <strong>7.Storage:</strong>
      ...
      <br />
      <br />
      Your information is encrypted and stored confidentially on our server (https://pro.paisago.in) and is completely deleted when the user's service is terminated.
    </p>
    ...
    <div class="head">How personal information is used</div>
    PaisaGo may use your personal information to develop and manage our relationship with you and our business partners. This may include the following: Providing information about PaisaGo products, services and transactions that may be of interest to you; Providing a more consistent experience for you and our business partners when interacting with PaisaGo, including better understanding who you are and how you use and interact with PaisaGo websites, applications, products and services; Planning, managing and executing our business partners.
    <br />
    <br />
    Communicate with you. This may include: Information about PaisaGo products, services and promotions that may be of interest to you; Information about PaisaGo products, services and transactions, e.g., pricing information, product or service enhancements; Responses to your questions or requests, including customer service requests; Invitations to participate in customer satisfaction surveys or market research or information about survey results.
    <br />
    <br />
    ...
    <br />
    <br />
    <div class="head">Transfer of Information to Third Parties</div>
    ...
    <br />
    <br />
    <div class="head">Changes to our Privacy Policy.</div>
