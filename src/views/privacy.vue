<template>
  <div class="h5-content">
    ...
    <br />
    <br />
    Process any orders or requests you may place.
    <br />
    <br />

    Manage or otherwise perform our obligations under any agreement with our business-related partners.
    <br />
    <br />
    Anticipate and solve any problems with the services we provide for you.
    <br />
    <br />
    Notify you of special promotions or offers. We may also notify you of new services or features. These may include quotations or products from our business partners (such as insurance companies) or third parties with whom we have relationships (such as marketing partners and other service providers).
    <br />
    <br />
    In order to improve the quality of our website and the services we provide. We may combine the information you provide with the information provided by business partners or other third parties.
    <br />
    <br />
    Send you notifications, messages and reminders related to your use of services on the website.
    <br />
    <br />
    When we have the obligation to fulfill our legal obligations according to the current legal framework.
    <br />
    <br />
    <br />
    <br />
    ...
    <br />
    <br />
    We may share the information you provide on this website with third parties/service providers/business partners without your prior consent in the following limited circumstances
    <br />
    <br />
    ...
    <br />
    <br />
    A cookie is a small data that is associated with personal information stored on a user's computer. You can use both persistent cookies and session ID cookies. The session ID cookie is expired and discarded when your browser closes or logs out. Persistent cookies is a small text file that will be stored on your computer's hard drive for long periods. PRPs may use session ID cookies to track user preferences while users are using the site. It also contributes to shortening server processing time and load time. PRP may use persistent cookies to store information such as whether you wish to save the password or other settings. The PrP website contains no cookies to save personal information.
    <br />
    <br />
    Security
    <br />
    <br />
    We always use appropriate technical and organizational security means to protect the information we have received from us. We use electronic, procedural and physical security methods to protect against illegal use, illegal tampering, and accidental loss, destruction, and damage of information. However, electronic preservation and communication methods on the Internet are not completely safe. This does not guarantee complete security. You shall also be responsible for the safe management of your login ID and password and shall not be disclosed to any third party.
    <br />
    <br />
    Tracking technology.
    <br />
    ...
    <br />
    <br />
    We work with third parties to view or manage ads on our mobile app and / or mobile website. Our third-party partners may use technologies such as cookies to collect information about your activities on this mobile app and / or mobile website, and other websites to view target ads based on your browsing habits and interests.
    <br />
    <br />
    ...
    Financial Fitness Report and Credit Report:
    <br />
    <br />
    Our reports are only available online within minutes of receiving payments, your reports are sent online by email on your registered mail id. Purchase of the report also give you an access to the Fitness Report on our customer Experience App for a period of 12 months. Access to the report in App is valid for 12 months, post 12 months you are required to renew/re-subscribe/purchase again for 12 months. Since the reports are based on multiple factors including your repayment history on loans, cards and others, your FFR/CR get changed/updated every 45 days. Therefore, for the latest and updated information we recommend you to re-subscribe/purchase your report after 12 months. One time purchase gives you an access for 12 months’ period.
    <br />
    <br />
    Refund Policy:
    <br />
    <br />
    Please read all the available information about financial report etc. before buying or subscribing or re-subscribing our reports. Due to the analytical, assessment nature of the information contained in our reports, cancellation of purchase/orders/subscribe/ re-subscribe cannot be accepted after the report has been delivered.
    <br />
    <br />
    About Apps And Loans Feature
    <br />
    <br />
    Users can get free credit report, check credit score.
    <br />
    <br />
    Track Outstanding on Your Loans & Cards.
    <br />
    <br />
    Analyze Options to Save Money on Existing Loans & Cards.
    <br />
    <br />
    ...
    <br />
    <br />
    Evaluate how to save on your existing loans and cards
    <br />
    <br />
    Personalised loan recommendations and offers based on credit score/information provided by the customer.
    <br />
    <br />
    Check Loan Eligibility for Personal Loan, Home Loan, Loan Against Property, Unsecured Business Loan, Gold Loan etc.
    <br />
    <br />
    Check Loan EMI
    <br />
    ...
    <br />
    <br />
    Information provided by a user must be accurate to access an error-free credit report.
    <br />
    <br />
    <br />
    <br />
