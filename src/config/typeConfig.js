const minuteLargeDdePulseQulet = {
  ...
  tipsTop: '大单回调是由财联社舞阳打造的智能化分析模型，通过对超大单金额的净流入表现，在盘中实时筛选流通市值较小，最近几个交易日资金介入较强、并且出现回调走势的标的。并提供相关智能策略讲解和案例供用户参考（不作为投资建议）。',
...
const minutePulseQulet = {
  ...
  tipsTop: '强势回调是由财联社舞阳打造的智能化分析模型，监控曾经大资金流入并且出现大阳线的标的，筛选出流通市值较大的标的回调机会，并提供相关智能策略讲解和案例供用户参考（不作为投资建议）。',
...
const minuteDivingGold = {
  ...
  tipsTop: '潜水捞金是由财联社舞阳打造的智能化分析模型，盘中实时更新当日股价分时涨幅较低，且资金逆势持续介入的标的。并提供相关智能策略讲解和案例供用户参考（不作为投资建议）。',
